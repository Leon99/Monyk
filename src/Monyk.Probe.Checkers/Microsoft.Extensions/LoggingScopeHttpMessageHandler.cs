...
{
    internal class LoggingScopeHttpMessageHandler : DelegatingHandler
    {
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            using (Log.BeginRequestPipelineScope(_logger, request))
            {
                ...
                Log.RequestPipelineEnd(_logger, response, elapsedTime);
                response.Headers.Add("X-Monyk-ElapsedTime", elapsedTime.TotalMilliseconds.ToString());
                return response;
            }
        }
